# DexStore websocket interface (dexstorejs-ws)

Pure JavaScript DexStore websocket library for node.js and browsers. Can be used to easily connect to and obtain data from the DexStore blockchain via public apis or local nodes.

Credit for the original implementation goes to [jcalfeee](https://github.com/jcalfee).

[![npm version](https://img.shields.io/npm/v/dexstorejs-ws.svg?style=flat-square)](https://www.npmjs.com/package/dexstorejs-ws)
[![npm downloads](https://img.shields.io/npm/dm/dexstorejs-ws.svg?style=flat-square)](https://www.npmjs.com/package/dexstorejs-ws)
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/dexstore/dexstorejs-ws/build/dexstorejs-ws.js" />
```

A variable dexstore_ws will be available in window.

For use in a webpack/browserify context, see the example below for how to open a websocket connection to the Openledger API and subscribe to any object updates:

```
var {Apis} = require("dexstorejs-ws");
Apis.instance("wss://dexstore.openledger.info/ws", true).init_promise.then((res) => {
...
This is a non-exhaustive list of endpoints available from the witness_node executable, which provides the API server of Dexstore.

## database_api
https://github.com/DexStore/DexStore/blob/master/libraries/app/database_api.cpp
